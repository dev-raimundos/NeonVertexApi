...
│                        # classes under each module's Persistence/ folder). Never a module's
...
└── Modules/
    └── <Module>/                        # e.g. Users, Authentication, Shopping, Finances
        ...
        │   # Infrastructure project instead (see Persistence/ below), keeping Domain framework-
        ...
        │   ├── Persistence/     # IEntityTypeConfiguration<T> classes (e.g. UserConfiguration), one per
        │   │                    # entity declared in this module's Domain — not in Domain itself, so
